...
제한된 리뷰 세션으로 동작합니다. 이후 피드백이 현재 묶음에 조용히 추가되지는
않습니다. 예산이 남아 있는 동안 같은 결함군의 차단성 피드백은 현재 세션에
합류할 수 있지만, 비차단 피드백은 대기열에 둡니다. 새로운 결함군이나 중요한
전략 결정이 생기면 사용자 안내를 위해 세션을 일시 중지합니다.
